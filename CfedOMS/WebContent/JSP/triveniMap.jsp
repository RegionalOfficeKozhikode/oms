    ...
    var myLatLng = new google.maps.LatLng(beach[1], beach[2]);
		...
		google.maps.event.addListener(marker, 'click', (function(marker, i) {
            return function() {
             ...
             var infoWinwhtml = '<div id="infowindow"><H4>'+locations[i][0]+'</H4> 0495 2721081 </div>';
             infowindow.setContent(infoWinwhtml);
             var infoHtml = '<div  class="triveniInfo"><H5>'+locations[i][0]+'</H5></br><p><img src="'+locations[i][3]+'" alt="'+locations[i][0]+' image "><br><br> Distance from RO : 200km <br> Landline number : 0495 2432510 <br>Incharge Name : Smitha <br> Total Staff : 3 <br> Total Systems : 2 <br> Area in Sq feet : 35 <br>Rent : 10000 <br> Agreement Date : 01-01-2018 <br> Started on : 01-01-2014 <br> 2013-14 sale : 300 <br> 2014-15 sale : 400 <br> Avergae sale per day : 66000 <br> Nearest Triveni : TSM kalpetta </p></div>';
